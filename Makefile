...
game.out: game.o system.o display_char.o ir.o led.o nav.o scoring.o ir_uart.o pio.o prescale.o timer.o timer0.o usart1.o display.o ledmat.o navswitch.o font.o pacer.o tinygl.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
